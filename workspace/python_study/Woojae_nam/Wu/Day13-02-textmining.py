...
def csvData03() :  # 여러개 csv 파일의 행개수 합계 궁금함.
    ...
    #############################################
    # (1) 여러 개의 CSV 데이터를 분석해서 모든 파일의 행 개수의
    #       합계를 추출하는 파이썬 코드 완성
    for input_file in file_list:
        ...
        totalCountList.append(rowCount)
    # print(totalCountList)
    totalCount = sum(totalCountList)
    print(totalCount)
...
csvMenu.add_command(label='여러 CSV 행수 및 합계', command=csvData03)
window.mainloop()
