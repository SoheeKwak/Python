# RAW --> Excel 로 쓰기 (예:128x128의 셀레 데이터 쓰기)
from xlsxwriter import Workbook
import os
import math

inFileName = 'C:\\Users\\403-3\\Desktop\\Pet_RAW\\Pet_RAW(64x64)\\dog06_64.raw'
outFileName = 'C:\\Users\\403-3\\Desktop\\Pet_Color\\images\\dog06_64.xlsx'
...
with open(inFileName, 'rb') as fReader :
    ...
    #워크시트의 열 너비/행 높이를 지정
    ws.set_column(0, XSIZE, 1.0) #약 0.34
    for r in range(YSIZE):
        ws.set_row(r, 9.5) #약 0.35
